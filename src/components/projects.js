      ...
      return (
         ...
         */}
          ...
          <Card shadow={5} style={{ minWidth: "450", margin: "auto" }}>
            ...
            <CardText>Giphy api</CardText>
            <CardActions className="project-content" border>
              <a
                href="https://github.com/myshuker/hyf-homework/tree/master/javascript/javascript3/week1/Giphy%20api"
                target="_blank"
              >
                {" "}
                GitHub
          ...
          <Card shadow={5} style={{ minWidth: "450", margin: "auto" }}>
            ...
            <CardText>Shopping cart using Classes</CardText>
            <CardActions className="project-content" border>
              <a
                href="https://github.com/myshuker/hyf-homework/tree/master/javascript/javascript3/week3/Shopping"
                target="_blank"
              >
                {" "}
                GitHub
          ...
          <Card shadow={5} style={{ minWidth: "450", margin: "auto" }}>
            ...
            <CardText>
              {" "}
              Two users compete about who can press a key the most times within
              a set time!
            </CardText>
            <CardActions className="project-content" border>
              <a
                href="https://github.com/myshuker/hyf-homework/tree/master/javascript/javascript2/week3/game"
                target="_blank"
              >
                {" "}
                GitHub
      ...
      return (
        <div className="project-grid">
          ...
          <Card shadow={5} style={{ minWidth: "450", margin: "auto" }}>
            ...
            <CardText>shopping website With HTML/Css</CardText>
            <CardActions className="project-content" border>
              <a
                href="https://github.com/myshuker/hyf-homework/tree/master/html-css/week3"
                target="_blank"
              >
                {" "}
                GitHub
